...
def lambda_handler(event, __):
    ...
    try:
        ...
        validate_body(body)
        #
        #         # Validate if the tricycle exists
        #         if not tricycle_exists(body['id']):
        #             raise RuntimeError("Tricycle does not exist")
        #
        # Delete tricycle
...
#
# # Validate if the tricycle exists
# def tricycle_exists(id_tricycle):
#     """ This function validates if the tricycle exists in the database
#
#     Parameters:
#     -----------
#     id_tricycle (int): The tricycle id
#
#     Raises:
#     -------
#     RuntimeError: If the tricycle does not exist
#     """
#     connection = get_db_connection()
#     try:
#         with connection.cursor(DictCursor) as cursor:
#             # Search tricycle
#             sql = "SELECT * FROM tricycle WHERE id = %s"
#             cursor.execute(sql, (id_tricycle,))
